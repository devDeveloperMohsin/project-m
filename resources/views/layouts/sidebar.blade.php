<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li
      class="menu-item {{ Route::currentRouteName() == 'workspaces' || (Route::currentRouteName() == 'workspaces.show' && !in_array(request('id'), $markedWorkspaces->pluck('id')->toArray()) ? true : false) ? 'active' : '' }}">
    ...
    @foreach ($markedWorkspaces as $w)
      <li
        class="menu-item {{ Route::currentRouteName() == 'workspaces.show' && $w->id == request('id') ? 'active' : '' }}">
        <a href="{{ route('workspaces.show', $w->id) }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-file"></i>
          <div data-i18n="Documentation">{{ $w->name }}</div>
        </a>
      </li>
    @endforeach
    ...
    @empty
      <li class="menu-item">
        <a href="javascript:void(0)" class="menu-link text-white bg-primary">
          <i class="menu-icon tf-icons bx bx-error-circle"></i>
          <div data-i18n="Support">Starred projects will appear here</div>
        </a>
      </li>
    @endforelse
